...
import 'package:flutter_market_app/add_product/add_product_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: categoryController.category != 'Favorites'
          ? FloatingActionButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (builder) =>
                        AddProductScreen(category: categoryController.category),
                  ),
                );
              },
  ...
  AppBar myAppBar() {
    return AppBar(
      toolbarHeight: _scrollPosition == 0 ? 150 : 72,
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (builder) => const CartScreen())).then((value) => setState(() {}));
                    },
                    child: Ink(
                      height: 40,
                      width: 65,
  ...
  Padding productPrice(Product product) {
    return Padding(
